...
<%
request.setAttribute("pageTitle", "게시판 마스터 상세");
request.setAttribute("extraHead",
        ...
        + request.getContextPath() + "/resources/js/mstr/detail.js\"></script>");
request.setAttribute("contentPage", "/WEB-INF/jsp/mstr/bbsMasterDetail_body.jsp");
%>
