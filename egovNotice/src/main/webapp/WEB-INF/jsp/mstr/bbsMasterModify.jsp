...
<%
request.setAttribute("pageTitle", "게시판 마스터 수정");
request.setAttribute("extraHead",
        ...
        + request.getContextPath() + "/resources/js/mstr/modify.js\"></script>");
request.setAttribute("contentPage", "/WEB-INF/jsp/mstr/bbsMasterModify_body.jsp");
%>
