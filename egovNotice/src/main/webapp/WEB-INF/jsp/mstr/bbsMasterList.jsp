...
<%
request.setAttribute("pageTitle", "게시판 마스터 관리");
request.setAttribute("extraHead",
        ...
        + request.getContextPath() + "/resources/js/mstr/list.js\"></script>");
request.setAttribute("contentPage", "/WEB-INF/jsp/mstr/bbsMasterList_body.jsp");
%>
